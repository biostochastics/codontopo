...
def topology_definitions_audit() -> dict:
    ...
    Computes all four combinations of two topology definitions and two
    adjacency models (Q_6 and K_4^3), allowing comparative assessment of
    the "creates a new disconnection from a previously connected family"
    (new-disconnection) vs. Δβ₀>0 (any-component-increase) definitions.

    Cells (possible_breaks, observed_breaks, rate_obs, rate_poss,
    depletion, hypergeom_p, RR, CI):
      - Q_6 with new-disconnection
      - Q_6 with Δβ₀>0
