...
CLAIM_HIERARCHY: list[Claim] = [
    ...
    Claim(
        ...
        statement=(
            "Organisms with variant genetic codes tend to show elevated "
            "tRNA gene copy numbers for the reassigned amino acid; the "
            "median Stouffer p across all maximal independent pairing "
            "subsets falls below 0.05 but the worst-case subset does not, "
