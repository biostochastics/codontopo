...
# Status palette (for verified/tested/pending/null/tautological/exploratory)
# Primary evidence gradient: verified (blue) -> tested (teal) -> pending (gold) -> null (red)
# Secondary categories: tautological (mid grey), exploratory (muted purple) — held
# visually distinct from the primary gradient so the honest-null "Falsified"
# result stays perceptually salient.
PAL_STATUS <- c(
  "verified"     = PAL_BLUE,
  "tested"       = PAL_TEAL,
  "pending"      = PAL_GOLD,
  "null"         = PAL_RED,
  "tautological" = PAL_GREY,
  "exploratory"  = "#B39DDB"   # muted lavender, colour-blind-safe against the RdBu gradient
)
